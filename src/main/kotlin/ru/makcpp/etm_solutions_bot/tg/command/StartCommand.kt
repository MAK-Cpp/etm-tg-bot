        ...
        telegramClient.sendMessage(
            SendMessage.builder()
                ...
                .text("""
                    ...
                    ВАЖНО: бот находится в бета-версии, поэтому:
                    1) Следуйте инструкциям максимально точно,
                    2) Отправляйте либо текст, либо картинки, если от вас это требуют,
                    
                    В противном случае, вы можете не получить желаемый результат.
                """.trimIndent())
                .build()
        )
        return EmptyState
